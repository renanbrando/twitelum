        ...
        return (
            <article className="tweet">
                <div className="tweet__cabecalho">
                    <img className="tweet__fotoUsuario" src={this.props.tweet.usuario.foto} alt="" />
                    <span className="tweet__nomeUsuario">{`${this.props.tweet.usuario.nome} ${this.props.tweet.usuario.sobrenome}`}</span>
                    <a href="/"><span className="tweet__userName">{`@${this.props.tweet.usuario.login}`}</span></a>
                </div>
                <p className="tweet__conteudo">
                    ...
                    <span>{ this.props.tweet.conteudo}</span>
                </p>
